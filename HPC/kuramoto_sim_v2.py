...
class KuramotoFast:
    ...
    def _init_parameters(self):
        ...
        for idx, frequency in enumerate(self.node_frequencies):
            # Palva uses Gaussian with mean=frequency, std=frequency_spread
...
if __name__ == "__main__":
    ...
    k_values = np.concatenate([
        np.linspace(1, 18, 5),    # coarse below critical
        np.linspace(18, 35, 20),  # fine around critical
        np.linspace(35, 60, 5)    # coarse above critical
    ])
    ...
    #output_dir2 = "/scratch/work/diazde1"
